...
namespace Nebula.Utilities
{
    public class FakeUtility
    {
        ...
        private static string CreateLetters(int minLength = 3,int maxLength = 12)
        {
            var str = RandomUnitily.RandomLetter(minLength, maxLength);
            return str;
        }
